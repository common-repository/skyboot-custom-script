<?php 
/*
Plugin Name: Skyboot Custom Script - Insert Headers and Footers Custom CSS and Javascript Code
Plugin URI:   http://skybootstrap.com
Description:  Insert your Custom CSS and Custom JS in Header & Footer tag. like: Social media script, google analytics code, GA4 property code, etc.
Version:      1.0.6
Author:       skybootstrap
...
*/
	...
	define( 'SCS_CUSTOM_SCRIPT_VERSION', '1.0.6' );
